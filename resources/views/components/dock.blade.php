<div class="dock sticky z-40">
    <a href="/plants" class="@if(request()->routeIs("plants.*")) dock-active @endif">
    ...
    <a href="/dashboard" class="@if(request()->routeIs("dashboard.*")) dock-active @endif">
    ...
    <a href="/settings" class="@if(request()->routeIs("settings.*")) dock-active @endif">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-6 w-6">
