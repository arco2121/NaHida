<div class="absolute top-2 right-15 z-50">
    <button
        id="btn_toggle_sound"
        class="btn btn-ghost btn-sm btn-square"
        title="Disattiva suoni"
        aria-label="Suoni attivi"
    >
        <svg data-sound-icon width="22" height="22" viewBox="0 0 24 24" fill="none"
             xmlns="http://www.w3.org/2000/svg" style="transition: opacity 0.2s;">
